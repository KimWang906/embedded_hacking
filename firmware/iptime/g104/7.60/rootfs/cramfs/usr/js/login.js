...
//login_navi
function login_main(flag,width,height)
{
	if(flag)
	{
        	Child_id=window.open('../cgi-bin/timepro.cgi?tmenu=main_frame&smenu=main_frame','login_main','width='+width+',height='+height+',scrollbars=auto,menubar=no,toolbar=no,resizable=no');
		Child_id.focus();
	}
	else
	{
