...
//var PLUGIN_MENU_STATUS_NOT_INSTALLED=0
//var PLUGIN_MENU_STATUS_DOWNLOADING=1
//var PLUGIN_MENU_STATUS_INSTALLED=2
//var PLUGIN_MENU_STATUS_NEED_UPDATE=3
	...
	for(i=0 ; i < bt_objs.length; i++)
	{
		...
		switch(status_code)
		{
			...
			case PLUGIN_STATUS_INSTALL_FAIL:
				...
				//PluginHideSetupLine(pkg_objs[i].value);
				break;
			case PLUGIN_STATUS_START_INSTALL:
			case PLUGIN_STATUS_START_UPDATE:
			case PLUGIN_STATUS_INSTALLING:
